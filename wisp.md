...
```html
<script type="module">
  import wisp from "https://cdn.jsdelivr.net/npm/@renderdragonorg/wisp/dist/index.js";
...
```typescript
import wisp, { type WispTransport } from "@renderdragonorg/wisp";
...
```typescript
import type { WispPlugin, WispClientInternal } from "@renderdragonorg/wisp";
