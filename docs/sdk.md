...
```typescript
import { init, type WispTransport } from "@yourorg/wisp";
...
```typescript
import { init, type WispPlugin, type WispClientInternal } from "@yourorg/wisp";
